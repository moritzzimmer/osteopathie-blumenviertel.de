...
const cacheName = 'localhost-superpwa-2.0.2';
const startPage = 'https://www.osteopathie-blumenviertel.de/';
const offlinePage = 'https://www.osteopathie-blumenviertel.de/';
